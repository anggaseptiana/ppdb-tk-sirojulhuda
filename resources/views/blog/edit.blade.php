...
@section('content')
    ...
    @foreach ($blog as $b)
   <form action="/admin/blog/{{ $b->id }}" method="post" enctype="multipart/form-data">
    @csrf

    <section id="step1" class="m-0 p-0 info-step">
        <p class="text-medium fs-5 mb-2">Edit Blog</p>
        @if(session('success'))
    ...
    @endif
        ...
        <div class="mb-2 row">
            ...
            <div class="col-12 col-md-9">
                ...
                <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" id="tanggal" required value="{{$b->tanggal}}">
                @error('tanggal_lahir')
        ...
        <div class="mb-2 row">
            ...
            <div class="col-12 col-md-9">
                <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" id="judul" required value="{{ $b->judul }}">
                @error('judul')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-2 row">
            ...
            <div class="col-12 col-md-9">
                <input type="hidden" name="oldImage" value="{{ $b->foto }}">
        ...
        <div class="mb-2 row">
            ...
            <div class="col-12 col-md-9">
                <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan" placeholder="Isi keterangan blog" required rows="3">{{ $b->keterangan }}</textarea>
                @error('keterangan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
